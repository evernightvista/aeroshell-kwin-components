...
MainWindow::MainWindow(QSpinBox *spinbox, QSpinBox *spinboxg, QCheckBox *checkbox,
  ...
  QLabel *titleLabel = new QLabel("<html><head/><body><p><span style=\" font-size:12pt;\">" + i18nd("aeroshell-kwin-components", "Change the color of your window borders, Start menu, and taskbar") + "</span></p></body></html>");
...
void MainWindow::changeColor(int index, bool apply) {
  ui->color_name_label->setText(i18nd("aeroshell-kwin-components", "Current color: %1", predefined_colors[index].getName()));
...
void MainWindow::changeCustomColor(bool apply) {
  if (!preventChanges) {
    ...
    ui->color_name_label->setText(i18nd("aeroshell-kwin-components", "Current color: %1", predefined_colors[0].getName()));
    QColor c;
...
void MainWindow::on_colorMixerLabel_linkActivated(const QString &link) {
  ...
  ui->colorMixerLabel->setText(ui->colorMixerGroupBox->isVisible()
                                   ? "<a style=\"color: #0066D4\" href=\"no\">" + i18nd("aeroshell-kwin-components", "Hide color mixer") + "</a>"
                                   : "<a style=\"color: #0066D4\" href=\"no\">" + i18nd("aeroshell-kwin-components", "Show color mixer") + "</a>");
}
